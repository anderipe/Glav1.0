/*
 * File: app/view/servicios/otros/resumensemanal.js
 *
...
Ext.define('siadno.view.servicios.otros.resumensemanal', {
    extend: 'Ext.window.Window',
    alias: 'widget.ServiciosOtrosResumenSemanal',
                    ...
                    items: [
                        {
                            ...
                            flex: 10,
                            margins: '0 3 0 0',
                            fieldLabel: 'Semana del Informe (Seleccione cualquier día de la semana)',
                            labelAlign: 'top',
                            name: 'fecha',
                            format: 'Y/m/d',
                            submitFormat: 'Y-m-d',
            ...
            dockedItems: [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            margin: '0 0 0 10',
                            width: 637,
                            text: 'En la fila de ahorros, ingrese valores positivos para registrar ingresos de ahorros, estos se mostraran en la interfaz en rojo y negativos para representar una resta en la entrega de dinero. Para registrar entregas de ahorros registre valores negativos, estos se mostraran en la interfaz en verde y positivo para representar una suma en la entrega de dinero.'
                        },
                        {
                            xtype: 'tbfill'
                        },
    ...
    onGridcelleditingpluginBeforeEdit: function(e, eOpts) {
        if(eOpts.colIdx===0 || eOpts.colIdx===(e.grid.storeEmpleados.count()+1) || eOpts.rowIdx!==8){
            return false;
        }
    ...
    onGridcelleditingpluginEdit: function(editor, e, eOpts) {
        ...
        siadno.ajax.call(this, 'clases/interfaces/InterfazServiciosResumenSemanal.php', {accion:103, idempleado:idEmpleado, fecha:fecha, valor:valor, campo:campo}, callback);
    ...
    onPanelShow: function(component, eOpts) {
        this.miRender=function(rowIndex, value){
            ...
            if(rowIndex==8){
                if(valorNumerico>=0){
                    ...
                    var  valor=Ext.util.Format.number(value*-1.0, '0,000');
        ...
        var clase=Ext.ClassManager.get("siadno.store.servicios.listaempleados2");
        if(Ext.isEmpty(clase)){
            Ext.define('siadno.store.servicios.listaempleados2', {
                ...
                constructor: function(cfg) {
                    ...
                    me.callParent([Ext.apply({
                        ...
                        proxy: {
                            ...
                            type: 'ajax',
                            url: 'clases/interfaces/InterfazServiciosResumenSemanal.php',
                            reader: {
                                type: 'json',
        ...
        clase=Ext.ClassManager.get("siadno.store.servicios.semanales");
        if(Ext.isEmpty(clase)){
            Ext.define('siadno.store.servicios.semanales', {
                extend: 'Ext.data.Store',
        ...
        this.grid=Ext.ComponentQuery.query('ServiciosOtrosResumenSemanal grid')[0];
        this.fecha=Ext.ComponentQuery.query('ServiciosOtrosResumenSemanal datefield')[0];
        ...
        this.storeEmpleados=Ext.create('siadno.store.servicios.listaempleados2');
        this.storeEmpleados.load({
            ...
            callback: function(records, operation, success) {
                ...
                this.grid.reconfigure(Ext.create('siadno.store.servicios.semanales'));
