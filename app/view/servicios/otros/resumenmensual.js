/*
 * File: app/view/servicios/otros/resumenmensual.js
 *
...
Ext.define('siadno.view.servicios.otros.resumenmensual', {
    extend: 'Ext.window.Window',
    alias: 'widget.ServiciosOtrosResumenmensual',
    ...
    onPanelShow: function(component, eOpts) {
        ...
        var clase=Ext.ClassManager.get("siadno.store.servicios.listagastos");
        if(Ext.isEmpty(clase)){
            Ext.define('siadno.store.servicios.listagastos', {
                ...
                constructor: function(cfg) {
                    ...
                    me.callParent([Ext.apply({
                        ...
                        proxy: {
                            ...
                            type: 'ajax',
                            url: 'clases/interfaces/InterfazServiciosResumenMensual.php',
                            reader: {
                                type: 'json',
        ...
        this.grid=Ext.ComponentQuery.query('ServiciosOtrosResumenmensual grid')[0];
        this.fecha=Ext.ComponentQuery.query('ServiciosOtrosResumenmensual datefield')[0];
        ...
        this.storeGastos=Ext.create('siadno.store.servicios.listagastos');
        this.storeGastos.load({
            ...
            callback: function(records, operation, success) {
                ...
                //this.grid.getStore().getProxy().extraParams.idradicado=idRadicado;
