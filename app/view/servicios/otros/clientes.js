/*
 * File: app/view/servicios/otros/clientes.js
 *
...
Ext.define('siadno.view.servicios.otros.clientes', {
    extend: 'Ext.window.Window',
    alias: 'widget.ServiciosOtrosClientes',
    ...
    title: 'Administración de Datos Personales',
            ...
            items: [
                {
                    ...
                    bodyPadding: 10,
                    url: 'clases/interfaces/servicios/otros/InterfazClientes.php',
                    items: [
                        {
                            xtype: 'fieldset',
                            padding: '0 10 0 10',
    ...
    onComboboxSelect1: function(combo, records, eOpts) {
        ...
        var combo=Ext.ComponentQuery.query('ServiciosOtrosClientes combobox[name=identificacion]')[0];
    ...
    onComboboxKeyup: function(textfield, e, eOpts) {
        ...
        siadno.limpiarFormulario('ServiciosOtrosClientes', null, ['idtipoidentificacion', 'identificacion']);
        var key=e.getKey();
        if(key==13){        
            var comboIdTipoIdentificacion=Ext.ComponentQuery.query('ServiciosOtrosClientes combobox[name=idtipoidentificacion]')[0];
            var comboIdentificacion=Ext.ComponentQuery.query('ServiciosOtrosClientes combobox[name=identificacion]')[0];        
    ...
    onComboboxBlur: function(field, eOpts) {
        ...
        var hidden=Ext.ComponentQuery.query('ServiciosOtrosClientes hidden[name=idpersona]')[0];
    ...
    onComboboxSelect: function(combo, records, eOpts) {
        combo=Ext.ComponentQuery.query('ServiciosOtrosClientes combobox[name=idtipoidentificacion]')[0];
    ...
    onButtonClickGuardar: function(button, e, eOpts) {
        var callback=function(){    
            var button=Ext.ComponentQuery.query('ServiciosOtrosClientes button[name=cambiarIdentificacion]')[0];
            button.toggle(false);        
            this.cambiandoIdentificacion=0;    

            var identificacion=Ext.ComponentQuery.query('ServiciosOtrosClientes combobox[name=identificacion]')[0];
            var tipoIdentificacion=Ext.ComponentQuery.query('ServiciosOtrosClientes combobox[name=idtipoidentificacion]')[0];    
            this.traerPersona(tipoIdentificacion.getValue(),identificacion.getValue());
        };

        siadno.enviarFormulario.call(this, false, 'ServiciosOtrosClientes form', {accion:siadno.GUARDAR_DATOS}, callback, null);
    ...
    onButtonClickBorrar: function(button, e, eOpts) {
        ...
        siadno.enviarFormulario.call(this, false, 'ServiciosOtrosClientes form', {accion:siadno.BORRAR_DATOS}, callback, null);
    },
    ...
    onWindowBeforeShow: function(component, eOpts) {
        ...
        combo=Ext.ComponentQuery.query('ServiciosOtrosClientes combobox[name=idpais]')[0];
        combo.bindStore(Ext.create('siadno.store.sistema.paises'));
        combo.getStore().load(); 
    },

    traerPersona: function(idtipoidentificacion, identificacion) {
        siadno.enviarFormulario.call(this, true, 'ServiciosOtrosClientes form',{idtipoidentificacion:idtipoidentificacion, identificacion:identificacion}, null, null);
    },
    ...
    habilitarPersonaNatural: function(habilitar) {
        ...
        if(habilitar==1){
            campo=Ext.ComponentQuery.query('ServiciosOtrosClientes displayfield[name=digitoverificacion]')[0];
            campo.setVisible(false);
            campo=Ext.ComponentQuery.query('ServiciosOtrosClientes textfield[name=apellidos]')[0];
            campo.setDisabled(false);
            campo=Ext.ComponentQuery.query('ServiciosOtrosClientes radiofield[name=sexo]');    
            campo[0].setDisabled(false);
            campo[1].setDisabled(false);    
            campo=Ext.ComponentQuery.query('ServiciosOtrosClientes combobox[name=idpais]')[0];
            campo.setDisabled(false);    
            campo=Ext.ComponentQuery.query('ServiciosOtrosClientes datefield[name=fechanacimiento]')[0];
            campo.setDisabled(false);    
